...
<g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g>
    ...
    <script>
		...
		function addMail(email){
			var url = "<?=$templateFolder?>/ajax.php?type=addMail&email="+email+"&addtotable=<?=$arResult['EMAIL_ADD2BASE']?>&idPopup=<?=$arParams['ID_POPUP']?>&sessid="+BX('skyweb24_roulette').querySelector('input[name="sessid"]').value;
			BX.ajax({
              url:url,
              method:'POST',
              onsuccess: function(data){
        ...
        function getCoupon(id,text){
          ...
          var getContinue=true;
            ...
            BX.ajax({
              ...
              onsuccess: function(data){
                if(data=='not_unique'){
                  BX('skyweb24_roulette').querySelector('p.result_roll_not_unique').style.display='block';
                }else{
...
function roll_roulette_func(count){
  ...
  if(email.querySelector('input').value==''){
    ...
    setTimeout(function(){res_roll(sector, email.querySelector('input').value)},7000);
	}else{
		BX('skyweb24_roulette').querySelector('p.result_roll_not_unique').style.display='none';
        email.className+=" error";
        email.focus();

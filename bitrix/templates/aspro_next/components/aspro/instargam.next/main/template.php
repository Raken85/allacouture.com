	...
	if($arInstagramPosts && !$arInstagramPosts["meta"]["error_message"]):?>
		...
		<div class="item-views front blocks">
			...
			<div class="instagram clearfix">
				...
				<div class="items row1 flexbox1 flexslider" data-plugin-options='{"animation": "slide",  "directionNav": true,  "controlNav" :true, "animationLoop": true, "slideshow": false, "slideshowSpeed": 7000, "animationSpeed": 600, "counts": [<?=$iCountSlide;?>,4,3,2,1]}'>

			...
			<div class="wraps">
				<table class="data_table_props compare_view">
					...
					{$i="0";
						...
						foreach($arShowFileds as $code => $arProp){ $i++;?>
							<tr class="param">
								<td colspan='<?=$s;?>'>
					...
					if($arShowOfferFileds){
						foreach ($arShowOfferFileds as $code => $arProp){$i++;?>
							<tr class="param">
								<td colspan='<?=$s;?>'>
					...
					<?
					if($arShowProps){
						foreach ($arShowProps as $code => $arProperty){$i++;?>
							<tr class="param">
								<td colspan='<?=$s;?>'>
								<?=$arProperty["NAME"]?>
...
<tr>
					...
					<?if($arShowOfferProps){
						foreach($arShowOfferProps as $code=>$arProperty){$i++;?>
							<tr class="param">
								<td colspan='<?=$s;?>'>
									<?=$arProperty["NAME"]?>

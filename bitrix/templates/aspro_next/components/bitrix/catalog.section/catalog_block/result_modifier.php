...
//title,descr для страниц пагинаций
if (isset($_GET['PAGEN_1']) && intval($_GET['PAGEN_1'])>0) {
	$title = $arResult['NAME'].' | Страница '.intval($_GET['PAGEN_1']);
	$arResult['IPROPERTY_VALUES']['SECTION_META_TITLE'] = $title;
	$description = $arResult['NAME'].' для женщин от Аллы Кравченко. Интернет-магазин женской одежды и аксессуаров.';
	$arResult['IPROPERTY_VALUES']['SECTION_META_DESCRIPTION'] = $description;
}

// $this->__component->SetResultCacheKeys(array('NAV_RESULT'));

//редирект несуществующих страниц пагинаций на основной раздел

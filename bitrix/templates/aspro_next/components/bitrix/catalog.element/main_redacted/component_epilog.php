...
<?}?>
<?
$title = strtok($arResult["PREVIEW_TO_DESC"], '.').' ('.$arResult["NAME"].'): купить в интернет-магазине allacouture.com в Москве';
$desc = strtok($arResult["PREVIEW_TO_DESC"], '.').' от ALLACOUTURE. Широкий ассортимент платьев ручной работы в интернет-магазине allacouture.com. Качественные материалы, идеальный крой! Заказ по телефону: +7 (495) 150-54-98.';

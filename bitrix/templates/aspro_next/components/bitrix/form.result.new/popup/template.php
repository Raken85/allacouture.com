	...
	<?}else{?>
		...
		<div class="form_footer">
			...
			<input type="submit" class="btn btn-default" value="<?=$arResult["arForm"]["BUTTON"]?>" name="web_form_submit"
				<?if($arResult["arForm"]["SID"] == "CALLBACK"){?>
					onclick="yaCounter46773159.reachGoal('zakazat'); return true;"
				<?}elseif($arResult["arForm"]["SID"] == "TOORDER"){?>
					onclick="yaCounter46773159.reachGoal('send-quick-view'); return true;"
				<?}?>
			>
		</div>

...
?>
<div class="">
<form action="<?=POST_FORM_ACTION_URI?>" method="post" class="vote-form form form_modal">
...
<?
					...
					<?case 4://text field?>
						<span class="vote-answer-item vote-answer-item-textfield">
							<!-- <label for="vote_field_<?=$arAnswer["ID"]?>"></label> -->
							<div class="form__field field">
								<div class="field__control">
									<input type="text" placeholder="<?=$arAnswer["MESSAGE"]?>" name="vote_field_<?=$arAnswer["ID"]?>" id="vote_field_<?=$arAnswer["ID"]?>" <?
...
<div class="vote-form-box-buttons vote-vote-footer">
	<span class="vote-form-box-button vote-form-box-button-first"><input class="form__submit button" type="submit" name="vote" value="<?=GetMessage("VOTE_SUBMIT_BUTTON")?>" /></span>

...
<div class="form__field field js-form__field_more-file opened">
	<div class="field__control">
		<div class="fileupload">
			<input name="form_file_10" class="inputfile" size="0" type="file" id="friends-photo">
...
<div class="form__field field js-form__field_more-file">
        <div class="field__control">
          <div class="fileupload">
			<input name="form_file_11" class="inputfile" size="0" type="file" id="friends-photo1">
...
<div class="form__field field js-form__field_more-file">
	<div class="field__control">
		<div class="fileupload">
			<input name="form_file_12" class="inputfile" size="0" type="file" id="friends-photo2">
...
<div class="form__field field js-form__field_more-file">
	<div class="field__control">
		<div class="fileupload">
			<input name="form_file_13" class="inputfile" size="0" type="file" id="friends-photo3">
...
<div class="form__field checkbox">
    ...
    <div class="form__footer">
      	<input class="form__submit button button_black" <?=(intval($arResult["F_RIGHT"]) < 10 ? "disabled=\"disabled\"" : "");?> type="submit" name="web_form_submit" 

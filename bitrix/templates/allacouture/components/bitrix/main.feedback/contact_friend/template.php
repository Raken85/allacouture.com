    ...
    <div class="form__field field">
      <div class="field__control">
        <div class="fileupload">
          <input type="file" name="form_file_10" multiple id="contact-photo">
...
<div class="form__field field">
      <div class="field__control">
        <div class="fileupload">
          <input type="file" name="form_file_11" multiple id="contact-photo">
          <label for="contact-photo">Еще фото</label>
        </div>
      </div>
    </div>
<div class="form__field field">
      <div class="field__control">
        <div class="fileupload">
          <input type="file" name="form_file_12" multiple id="contact-photo">
          <label for="contact-photo">Еще фото</label>
        </div>
      </div>
    </div>
<div class="form__field field">
      <div class="field__control">
        <div class="fileupload">
          <input type="file" name="form_file_13" multiple id="contact-photo">
          <label for="contact-photo">Еще фото</label>
        </div>
      </div>
    </div>

...
<script>
			...
			<div class="form-control">
				<div class="wrap_md">
					<div class="iblock label_block">
						...
						<input class="adm-input adm-input-calendar birfday" type="text" onclick="BX.calendar({node:this, field:'PERSONAL_BIRTHDAY', form: '', bTime: false, bHideTime: false});" name="PERSONAL_BIRTHDAY" size="13" value="<?=$arResult["arUser"]["PERSONAL_BIRTHDAY"]?>">
						<span class="adm-calendar-icon" title="Нажмите для выбора даты" onclick="BX.calendar({node:this, field:'PERSONAL_BIRTHDAY', form: '', bTime: false, bHideTime: false});" style="    background: url(/bitrix/panel/main/images/bx-admin-sprite-small-2.png) no-repeat 0 -1934px;
    ...
    outline: none;
    position: absolute;
    width: 16px;margin-top: 30px;"></span>
					</div>
					<div class="iblock text_block">
						<?//=GetMessage("PERSONAL_PHONE_DESCRIPTION")?>
					</div>
			...
			<div class="form-control">
				<div class="wrap_md">
					<div class="iblock label_block select-multiple">
						<label><?=GetMessage("PERSONAL_SIZE")?></label>

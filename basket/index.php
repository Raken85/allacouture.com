...
<?$APPLICATION->IncludeComponent("bitrix:sale.basket.basket", "template1", Array(
	"COLUMNS_LIST" => array(
		...
		"ADDITIONAL_PICT_PROP_12" => "-",	// Дополнительная картинка [Предложения]
		"ADDITIONAL_PICT_PROP_29" => "MORE_PHOTO",	// Дополнительная картинка [Каталог товаров]
		"ADDITIONAL_PICT_PROP_32" => "MORE_PHOTO",	// Дополнительная картинка [Торговые предложения]
